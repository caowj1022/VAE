...
class VAE(nn.Module):
	def __init__(self, batch_size, input_size, hidden_size_1, hidden_size_2, z_dimension):
	...
	def init_hidden(self):
		return torch.zeros(2*2, self.batch_size, self.hidden_size_1), torch.zeros(2*2, self.batch_size, self.hidden_size_1)
...
if __name__ == '__main__':
	...
	model = VAE(32, 128, 2048, 1024, 512)
